...
typedef struct MQTTClient
{
    ...
    pthread_t ThreadPing; //the device of mqtt client keep alive with broker
    pthread_t TreadEventUpload;  //the device of mqtt client pub the data
    pthread_t ThreadParser;  //the device of mqtt client sub the data and parser
#endif
} MQTTClient;
